          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                Streamline operations, track labor attendance with
                biometric verification, manage fleet vehicles in
                real-time, and boost productivity with our
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <motion.div
                ...
                <div className="text-sitesathi-neutral">
                  {item.label}
                </div>
              </motion.div>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-on-scroll">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Everything you need to manage your construction projects
              efficiently, from labor tracking to fleet management.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  'Track labor attendance with advanced biometric verification including fingerprint, facial recognition, and RFID integration.',
                features: [
              ...
              },
              {
                ...
                description:
                  'Monitor vehicle locations, track maintenance schedules, and optimize fleet operations with real-time GPS tracking.',
                features: [
              ...
              },
              {
                ...
                description:
                  'Manage materials, track inventory levels, and streamline procurement processes with automated reorder points.',
                features: [
                  'Material tracking',
              ...
              },
              {
                ...
                description:
                  'Assign tasks, track progress, and ensure project milestones are met with comprehensive project management tools.',
                features: [
                  'Progress tracking',
                  'Team collaboration',
                  'Deadline management',
              ...
              },
              {
                ...
                description:
                  'Monitor project costs, track expenses, and generate detailed financial reports for better budget management.',
                features: [
                  'Cost tracking',
                  'Budget management',
                  'Financial reporting',
              ...
              },
              {
                ...
                description:
                  'Store, organize, and share project documents securely with version control and access permissions.',
                features: [
                  'Secure storage',
                  'Version control',
                  'Access permissions',
              ...
              <motion.div
                ...
                <Card className="h-full hover:shadow-xl transition-all duration-300">
                  <CardContent className="p-8">
                    ...
                    <h3 className="text-2xl font-bold text-buildtrack-neutral mb-4">
                      {feature.title}
                    </h3>
              ...
              {[
                {
                  ...
                  description:
                    'Access all features on-the-go with our responsive mobile app. Perfect for field workers and site managers.',
                ...
                },
                {
                  ...
                  description:
                    'Bank-level security with encrypted data transmission and secure biometric authentication systems.',
                ...
                },
                {
                  ...
                  description:
                    'Instant synchronization across all devices and platforms. Your team always has the latest information.',
                ...
                <motion.div
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-buildtrack-neutral mb-2">
                      {item.title}
                    </h3>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <motion.div
                ...
                transition={{ duration: 0.6 }}
                viewport={{ once: true }}>
                <h2 className="text-4xl font-bold text-buildtrack-neutral">
              ...
              <div className="grid grid-cols-2 gap-6">
                {[
                  ...
                  <motion.div
                    ...
                    <tech.icon
                      className={`h-8 w-8 ${tech.color} mx-auto mb-3`}
                    />
                    <h4 className="font-semibold text-buildtrack-neutral">
                      {tech.title}
                    </h4>
                  </motion.div>
                ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              {
                quote:
                  'The real-time monitoring capabilities have improved our project delivery times significantly. Highly recommend for any construction company.',
                ...
                <Card className="h-full">
                  <CardContent className="p-8">
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        <div className="font-semibold text-buildtrack-neutral">
                          {testimonial.name}
                        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            <p className="text-xl text-blue-100 mb-12 max-w-3xl mx-auto">
              We're continuously innovating to bring you even more
              powerful features for construction site management.
            </p>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 max-w-2xl mx-auto">
              <CardContent className="p-8">
                ...
                <p className="text-blue-100 mb-6">
                  Join our early access program and get notified when
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
              ...
              <div className="space-y-6">
                {[
                  ...
                  },
                  {
                    icon: MapPin,
                    title: 'Visit Us',
                    info: '123 Construction Ave, Building City, BC 12345',
                    color: 'text-buildtrack-accent',
                    bgColor: 'bg-green-50',
                  },
                ].map((contact, index) => (
                  <div key={index} className="flex items-center">
                    <div
                      className={`w-12 h-12 ${contact.bgColor} rounded-xl flex items-center justify-center mr-4`}>
                      <contact.icon
                        className={`h-6 w-6 ${contact.color}`}
                      />
                    </div>
                    <div>
                      <div className="font-semibold text-buildtrack-neutral">
            ...
            <motion.div
              ...
              <Card>
                <CardContent className="p-8">
                  <h3 className="text-2xl font-bold text-buildtrack-neutral mb-6">
                    Request a Demo
                  </h3>
                  <Form {...contactForm}>
                    <form
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400 mb-6">
                The complete construction site management platform for
                modern builders.
              </p>
          ...
          <div className="border-t border-gray-700 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="text-gray-400 mb-4 md:mb-0">
                © 2024 SiteSathi. All rights reserved.
              </div>
